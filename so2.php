<?php
	...
	if (!isset($_SESSION['user'])){
		...
		echo'<!DOCTYPE html>
			<html>
				<head>
					<title>Administración de salas - SO2</title>
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilos.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilosCSS3.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estiloSO2.css" />
				...
				<body>
					<div id="contenedor" class="container">
						<header>
							...
							<h1>Parte de incidencias sala ordenadores 2</h1>
						...
						<section class="ordenadores">
							<div id="pc15" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC15"  placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia"  form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC15" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc14" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC14" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC14" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc13" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC13" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC13" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc12" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC12" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC12" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc11" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC11" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC11" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc10" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC10" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC10" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc9" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC9" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC9" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc8" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC8" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC8" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc7" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC7" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC7" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc6" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC6" placeholder="Alumnos" rows="1" class="input-small" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC6" placeholder="Incidencias" rows="3" class="input-small" form="formIncidencia" ></textarea>
							</div>
							<div id="pc5" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC5" placeholder="Alumnos" rows="1" cols="22" form="formIncidencia" ></textarea>
							...
							<div id="pc4" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC4" placeholder="Alumnos" rows="1" cols="22" form="formIncidencia" ></textarea>
							...
							<div id="pc3" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC3" placeholder="Alumnos" rows="1" cols="22" form="formIncidencia" ></textarea>
							...
							<div id="pc2" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC2" placeholder="Alumnos" rows="1" cols="22" form="formIncidencia" ></textarea>
							...
							<div id="pc1" class="ordenador sombraOrdenador">
								...
								<textarea name="alumnosPC1" placeholder="Alumnos" rows="1" cols="22" form="formIncidencia" ></textarea>
								<textarea name="incidenciasPC1" placeholder="Incidencias" rows="3" form="formIncidencia" ></textarea>
							</div>
							<div id="despacho">
								<span>Despacho Informática</span>
							</div>
						</section>
						<footer class="pie">
							<p>
