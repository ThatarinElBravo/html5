<?php
	...
	if (!isset($_SESSION['user'])){
		...
		echo '<!DOCTYPE html>
			<html>
				<head>
					<title>Administración de salas - SO1</title>
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilos.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilosCSS3.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estiloSO1.css" />
				...
				<body>
					<div id="contenedor" class="container">
						<header>
							...
							<h1>Parte de incidencias sala ordenadores 1</h1>
							...
							<form id="formIncidencia" action="enviarParte.php" method="post">
								<table cellspacing="0" class="table table-bordered" >
									<tr>
										...
										<th>Profesor: <input type="text" name="profesor" disabled="disabled" value="'.$profesor[1].'" class="uneditable-input" /></th>
						...
						<section class="ordenadores">
							...
							<div id="pc5" class="ordenador sombraOrdenador">
								...
								<textarea name="incidenciadPC5" placeholder="Incidencias" rows="3" form="formIncidencia" ></textarea>
							</div>
							...
							<div id="puerta">
								<span>P<br/>u<br/>e<br/>r<br/>t<br/>a</span>
							</div>
							...
							<div id="pizarra">
								<span>P<br/>i<br/>z<br/>a<br/>r<br/>r<br/>a</span>
							</div>
						</section>
						<footer class="pie">
							<p>
