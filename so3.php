<?php
	...
	if (!isset($_SESSION['user'])){
		...
		echo'<!DOCTYPE html>
			<html>
				<head>
					<title>Administración de salas - SO3</title>
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilos.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estilosCSS3.css" />
					<link rel="stylesheet" type="text/css" media="screen" href="css/estiloSO3.css" />
				...
				<body>
					<div id="contenedor" class="container">
						<header>
							...
							<h1>Parte de incidencias sala ordenadores 3</h1>
